...
public:
    ...
    bool WasExecuted( void );					  // returns true if the FileEditCtrl was activated and sets the m_FEC_Activated flag to false
    bool m_WasExecuted;
...
protected:
    ...
    afx_msg LRESULT OnSetText(UINT, LPCTSTR);
