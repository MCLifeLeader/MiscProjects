...
CREATE TABLE dbo.VACATED_PUBACC_AN
(
   record_type              	 char(2)              NULL,
   unique_system_identifier  numeric(9,0)         NOT NULL,
   uls_file_number           	char(14)             NULL,
...
CREATE TABLE dbo.VACATED_PUBACC_EN
(
   record_type               char(2)              NOT NULL,
   unique_system_identifier  numeric(9,0)         NOT NULL,
   uls_file_number           char(14)             NULL,
...
CREATE TABLE dbo.VACATED_PUBACC_FR
(
   record_type               char(2)              NULL,
   unique_system_identifier  numeric(9,0)         NOT NULL,
   uls_file_number           char(14)             NULL,
...
CREATE TABLE dbo.VACATED_PUBACC_HD
(
   record_type               char(2)              NOT NULL,
   unique_system_identifier  numeric(9,0)         NOT NULL,
   uls_file_number           char(14)             NULL,
...
CREATE TABLE dbo.VACATED_PUBACC_LO
(
   record_type               char(2)              NOT NULL,
   unique_system_identifier  numeric(9,0)         NOT NULL,
   uls_file_number           char(14)             NULL,
...
CREATE TABLE dbo.VACATED_PUBACC_MK
(
   record_type               char(2)              NULL,
   unique_system_identifier  numeric(9,0)         NOT NULL,
   uls_file_number           char(14)             NULL,
...
CREATE TABLE dbo.VACATED_PUBACC_VS
(
   record_Type	        	      char(2)          NOT NULL,
   unique_system_identifier  	numeric(9,0)     NOT NULL,
   uls_file_number 	        	char(10)         NULL,
   ebf_number	            	varchar(30)       NULL,
   callsign                		char(10)         NOT NULL,
   public_safety_region	    	integer          NOT NULL,
   prioritization_wave	    	integer          NOT NULL,
   region_close_date       		char(10)       NULL
)
GO

-- Frequencies that are being auctioned

CREATE TABLE dbo.auction_freq
(
   auction_id           smallint            NOT NULL ,
   freq_channel_block   char(2)        NOT NULL ,
   freq_assigned        numeric(16,8)    NULL ,
   freq_upper_band      numeric(16,8)  NULL ,
   radio_service_code   char(2)        NULL 
)
GO
...
CREATE TABLE dbo.OWNER_PUBACC_O
(
   record_type	char(1)		NULL,
   frn_filer	char(10)	NULL,
   file_num	char(14)	NULL,
   filer_fname	varchar(20)	NULL,
   filer_mi	char(1)		NULL,
   filer_lname	varchar(20)	NULL,
   filer_suffix	char(3)		NULL,
   filer_name	varchar(200)	NULL,
   date_entered	char(10)	NULL,
   date_receipt	char(10)	NULL,
   certifier_fname	varchar(20)	NULL,
   certifier_mi	char(1)		NULL,
   certifier_lname	varchar(20)	NULL,
   certifier_suffix char(3)	NULL,
   certifier_title	char(40)	NULL,
   contact_company	varchar(70)	NULL,
   contact_fname	varchar(20)	NULL,
   contact_mi	char(1)		NULL,
   contact_lname	varchar(20)	NULL,
   contact_suffix	char(3)		NULL,
   contact_phone	char(10)	NULL,
   contact_fax	char(10)	NULL,
   contact_address	varchar(60)	NULL,
   contact_city	varchar(20)	NULL,
   contact_state	char(2)		NULL,
   contact_zip_code char(9)	NULL,
   contact_po_box	varchar(20)	NULL,
   contact_email	varchar(50)	NULL,
   form_num	char(3)		NULL,
   filing_type	char(1)		NULL,
   filing_status	char(1)		NULL,
   unique_system_identifier	numeric(9,0)	NULL
)
GO

-- Record Type F
--CREATE TABLE dbo.frb
CREATE TABLE dbo.OWNER_PUBACC_F
(
   record_type	char(1)		NULL,
   file_num	char(14)	NULL,
   business_name	varchar(200)	NULL,
   principal_business varchar(60)	NULL,
   frn	numeric(10)		NULL,
   pct_interest	numeric(5,2)	NULL,
   form_num	char(3)		NULL,
   filing_type	char(1)		NULL,
   filing_status	char(1)		NULL,
   unique_system_identifier	numeric(9,0)	NULL
...
-- Record Type H (FRB of DIH)
--CREATE TABLE dbo.frbofdih
CREATE TABLE dbo.OWNER_PUBACC_H
(
   record_type	char(1)		NULL,
   file_num	char(14)	NULL,
   business_name	varchar(200)	NULL,
   principle_business varchar(60)	NULL,
   frn	numeric(10)		NULL,
   dih_frn	numeric(10)		NULL,
   pct_interest	numeric(5,2)	NULL,
   form_num	char(3)		NULL,
   filing_type	char(1)		NULL,
   filing_status	char(1)		NULL,
...
-- Record Type D
--CREATE TABLE dbo.dih
CREATE TABLE dbo.OWNER_PUBACC_D
(
   record_type	char(1)	NULL,
   file_num	char(14)	NULL,
   entity_name	varchar(200)	NULL,
   type_entity	char(1)		NULL,
   ...
   international_address_ind char(1)	NULL,
   interest_direct	char(1)		NULL,
   interest_indirect	char(1)	NULL,
   interest_officer	char(1)	NULL,
   interest_director	char(1)	NULL,
   interest_key_mgmt	char(1)	NULL,
   interest_mgmt_contract	char(1)	NULL,
   interest_other	char(1)		NULL,
   interest_other_desc	char(255)	NULL,
   own_comm_stk	char(1)		NULL,
   own_comm_stk_vote_ind	char(1)	NULL,
   own_gen_part	char(1)		NULL,
   own_gen_part_vote_ind	char(1)	NULL,
   own_ltd_part	char(1)		NULL,
   own_ltd_part_vote_ind	char(1)	NULL,
   own_member	char(1)		NULL,
   own_option	char(1)		NULL,
   own_proprietor	char(1)		NULL,
   own_pref_stk	char(1)		NULL,
   own_pref_stk_vote_ind	char(1)	NULL,
   own_pref_stk_convert_ind	char(1)	NULL,
   own_warrant	char(1)		NULL,
   own_other	char(1)		NULL,
   own_other_desc	char(255)	NULL,
   pct_interest	numeric(5,2)	NULL,
   country_citizenship	char(40)	NULL, -- char(2)
   jurisdiction	char(2)		NULL,
   state_jurisdiction	char(2)	NULL,
   non_affiliate_option	char(1)	NULL,
   year1_in_existence	char(1)	NULL,
   year1_end_date	char(10)	NULL,
   year1_revenue	numeric(18)	NULL,
   year2_in_existence	char(1)	NULL,
   year2_end_date	char(10)	NULL,
   year2_revenue	numeric(18)	NULL,
   year3_in_existence	char(1)	NULL,
   year3_end_date	char(10)	NULL,
   year3_revenue	numeric(18)	NULL,
   total_assets	money		NULL,
   financial_statement_type 	char(1)	NULL,
   form_num	char(4)		NULL,
   filing_type	char(1)		NULL,
   filing_status	char(1)		NULL,
   unique_system_identifier	numeric(9,0)	NULL
)
...
-- Record Type A
--CREATE TABLE dbo.affliate
CREATE TABLE dbo.OWNER_PUBACC_A
(
   record_type	char(1)		NULL,
   file_num	char(14)	NULL,
   type_entity	char(1)		NULL,
...
CREATE TABLE dbo.OWNER_PUBACC_T
(
   record_type	char(1)		NULL,
   file_num	char(14)	NULL,
   attachment_code	char(1)		NULL,
